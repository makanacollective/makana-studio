...
import { documentList, localisedDocumentList, SINGLETON_ACTIONS, singletonDocument } from './lib/configUtils';
...
import { localisedSchemaTypeNames, schemaTypes, singletonSchemaTypeNames } from './schemaTypes';
        ...
        structureTool({
            structure: (S) => {
                return S.list().title('Content').items([
                    ...
                    S.divider().title('Supporting Content'),
